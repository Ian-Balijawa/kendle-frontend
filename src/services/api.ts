...
class ApiService {
    ...
    async getPosts( page = 1, limit = 10 ): Promise<PostsResponse> {
        const response: AxiosResponse<ApiResponse<PostsResponse>> = await this.api.get(
    ...
    async getComments( postId: string, page = 1, limit = 10 ): Promise<CommentsResponse> {
        const response: AxiosResponse<ApiResponse<CommentsResponse>> = await this.api.get(
    ...
    async getChats(): Promise<Chat[]> {
        const response: AxiosResponse<ApiResponse<Chat[]>> = await this.api.get( '/chats' )
        return response.data.data
    }
    ...
    async getNotifications( page = 1, limit = 20 ): Promise<Notification[]> {
        const response: AxiosResponse<ApiResponse<Notification[]>> = await this.api.get(
    ...
    async searchUsers( query: string, page = 1, limit = 10 ): Promise<UsersResponse> {
        const response: AxiosResponse<ApiResponse<UsersResponse>> = await this.api.get(
