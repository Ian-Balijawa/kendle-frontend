...
import { Box, ScrollArea, Group, Avatar, Text, Stack, Tooltip, Badge } from '@mantine/core';
import { useInfiniteMessages, useMarkConversationAsRead, useAddMessageReaction } from '../../hooks/useChat';
    ...
    return (
      <Group gap={4} mt={4}>
        {Object.entries(reactionCounts).map(([emoji, count]) => (
          <Tooltip key={emoji} label={`${count} reaction${count > 1 ? 's' : ''}`}>
            <Badge
              size="xs"
              variant="light"
      ...
      >
        ...
        >
          ...
          <Stack gap={4} style={{ minWidth: 0 }}>
            ...
            <Group gap={4} justify={isOwnMessage(message) ? 'flex-end' : 'flex-start'}>
