                                ...
                                <Stack gap="md">
                                    ...
                                    <Grid>
                                        ...
                                        <Grid.Col span={6}>
                                            ...
                                            <Text size="sm" c={user?.isProfileComplete ? "green" : "orange"}>
                            ...
                            <Card withBorder p="lg">
                                <Stack gap="md">
                                    ...
                                    <Group justify="space-between" align="center">
                                        ...
                                        <Button variant="light" size="sm" leftSection={<IconLock size={14} />}>
                                            Change
                                        </Button>
                                    </Group>
                                    <Divider />
                            ...
                            <Card withBorder p="lg">
                                <Stack gap="md">
                                    ...
                                    <Group justify="space-between" align="center">
                                        <Group gap="md">
                                            {theme === "dark" ? (
                                                <IconMoon size={20} color="var(--mantine-color-blue-6)" />
                                            ) : (
                                                <IconSun size={20} color="var(--mantine-color-orange-6)" />
                                            )}
                                            <Box>
                                                <Text size="sm" fw={500}>
