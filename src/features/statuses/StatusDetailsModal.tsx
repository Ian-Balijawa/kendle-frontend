...
import { IconChevronLeft, IconChevronRight, IconX, IconHeart, IconShare } from "@tabler/icons-react";
...
export function StatusDetailsModal({
    ...
    useEffect(() => {
        ...
        const duration = currentStatus.media.type === "video" ? currentStatus.media.duration || 5 : 5;
    ...
    }, [currentStatus, canGoNext, canGoNextCollection, onNext, onNextCollection, onClose, onViewStatus]);
                        ...
                        <Group gap="sm">
                            ...
                            <Box>
                                ...
                                <Text size="xs" c="rgba(255, 255, 255, 0.7)">
                                    {formatTimeAgo(currentStatus.createdAt)} • {getTimeRemaining()}
                                </Text>
                            </Box>
                        </Group>
                    ...
                    <Group justify="space-between" align="center">
                        ...
                        <Group gap="xs" align="center">
                            <Text size="sm" c="rgba(255, 255, 255, 0.7)" fw={500}>
                                {currentStatus.viewsCount} {currentStatus.viewsCount === 1 ? "view" : "views"}
                            </Text>
                        </Group>
                    </Group>
                </Box>
