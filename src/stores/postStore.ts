        ...
        state.selectedPost?.id === id
          ? {
              ...
              _count: {
                ...
                downvotes: state.selectedPost.isDownvoted
                  ? Math.max(0, state.selectedPost._count.downvotes - 1)
                  : state.selectedPost._count.downvotes,
              },
            }
          : state.selectedPost,
    }));
        ...
        state.selectedPost?.id === id
          ? {
              ...
              _count: {
                ...
                upvotes: state.selectedPost.isUpvoted
                  ? Math.max(0, state.selectedPost._count.upvotes - 1)
                  : state.selectedPost._count.upvotes,
              },
            }
          : state.selectedPost,
    }));
