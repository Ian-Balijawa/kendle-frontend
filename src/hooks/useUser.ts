...
export function useUpdateProfile() {
    ...
    return useMutation( {
        mutationFn: ( data: UpdateProfileRequest ) => apiService.updateUserProfile( data ),
        onMutate: async ( updateData ) => {
            ...
            if ( user ) {
                ...
                if ( updateData.username ) {
                    queryClient.setQueryData( userKeys.username( updateData.username ), updatedUser );
                }
            }
        ...
        onSuccess: ( updatedUser ) => {
            ...
            if ( updatedUser.username ) {
                queryClient.setQueryData( userKeys.username( updatedUser.username ), updatedUser );
            }
...
export function useCompleteUserProfile() {
    ...
    return useMutation( {
        mutationFn: ( data: UserProfileCompleteRequest ) => apiService.completeUserProfile( data ),
        onMutate: async ( profileData ) => {
            ...
            if ( user ) {
                ...
                queryClient.setQueryData( userKeys.detail( user.id ), updatedUser );
                queryClient.setQueryData( userKeys.username( profileData.username ), updatedUser );
            }
